//  import travelInsurance from "@/public/globe.jpg"
 ...
 const data = [
    {id: 1, question: "Educational Consulting", title: "Educational Consulting", answer: "Riskout Travels conducts comprehensive risk assessments to identify potential hazards and threatsns, transportation, and activities", img: "/risk.png", link: "/travels/insurance", button: "Learn More"},

    {id: 2, question: "Teachers' staffing", title: "Teachers' staffing", answer: "Riskout Travels assists travelers in selecting the right travel insurance policies to protect them against unforeseen events like", img: "/assurance.png" , link: "/travels/insurance", button: "Learn More"},

    {id: 3, question: "Cambridge Curriculum", title: "Cambridge Curriculum", answer: "Riskout Travels assists travelers in selecting the right travel insurance policies to protect them against unforeds", img: "/risk.png", link: "/travels/insurance", button: "Learn More"},
