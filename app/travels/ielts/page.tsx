...
const IeltsPage = () => {
  return (
    <div style={{maxWidth: "100vw"}}>
      ...
      <IeltsTakes subTitle='Check IELTS out' title='All You Need To Know About IELTS' desc=' All You Need To Know About IELTSAll You Need To Know About IELTSAll You Need To Know About IELTSAll You Need To Know About IELTS All You Need To Know About IELTS' videoAlt='Ielts Video' videoSrc="/https://youtu.be/nNOwg6LkDw4" btnBackLink='/linkToForm' btnBackText='Make Enquiry' btnLink='/Contact Us' btnText='Contact Us' />
