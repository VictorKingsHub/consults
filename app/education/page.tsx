...
const educationPage = () => {
  return (
    <div>
      ...
      <Testimonial topHeader='Students Testimonials' topDesc='Get the most satisfying servicesGet the most satisfying servicesGet the most satisfying services Get the most satisfying services' name1='Victoria Marvalous' name2='Johnson Lifting' name3='Ikeogu Earnest' prof1='Virtual Assitant' prof2=' Data Analyst ' prof3=' Software Developer ' desc1='Get the most satisfying servicesGet the most satisfying servicesGet the most satisfying services Get the most satisfying services' desc2='Get the most satisfying servicesGet the most satisfying servicesGet the most satisfying services Get the most satisfying services' desc3='Get the most satisfying servicesGet the most satisfying servicesGet the most satisfying services Get the most satisfying services' img1={"/review1.jpg"} img2={"/review2.jpg"} img3={"/review3.jpg"} />
